...
const VerifyEmail = () => {
  ...
  return (
    <div className="min-h-screen flex rounded-4xl items-center justify-center p-4 relative z-10">
      ...
      <form
        ...
        transition-all duration-700 ease-in-out w-full max-w-lg mx-auto py-10 px-6 sm:px-10 text-white flex flex-col items-center gap-8
