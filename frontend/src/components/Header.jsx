    ...
    >
      <Particles
        ...
        options={{
          background: {
            color: {
              value: "transparent", // Keep background transparent to show Header's background image
            },
          },
          fpsLimit: 120,
          fullScreen: {
          ...
          interactivity: {
            events: {
              ...
              onHover: {
                enable: true,
                mode: "bubble", // Particles bubble on hover
              },
              resize: true,
            },
            modes: {
              bubble: {
                distance: 100, // Distance for bubble effect
                duration: 2,
                opacity: 0.8,
                size: 8,
                speed: 3,
          ...
          particles: {
            number: {
              value: 50, // Fewer particles for a less busy look in the header
              density: {
                enable: true,
                area: 800,
              },
            ...
            color: {
              value: ["#FFD700", "#00FFFF", "#FF00FF"], // Gold, Cyan, Magenta for a vibrant look
            },
            shape: {
              type: "star", // Using stars for a different effect
            },
            opacity: {
              value: 0.7,
              random: {
            ...
            links: {
              enable: false, // No links for a cleaner look
            },
            move: {
              enable: true,
        ...
        style={{
          position: "absolute",
          zIndex: 15, // Higher than the overlay but lower than content
          top: 0,
          left: 0,
          right: 0,
          bottom: 0,
