    ...
    try {
      ...
      if (currState === "Login") {
        ...
        if (response.data.success) {
          ...
          // toast.success(response.data.message); // Show login success message
          navigate("/");
        } else {
        ...
        if (response.data.success) {
          ...
          toast.error(response.data.message);
          // If user exists but not verified, register endpoint will return userId to redirect to verify-otp
      ...
      // Handle cases where login fails due to unverified email
